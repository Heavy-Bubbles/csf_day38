...
import sg.edu.nus.iss.server.models.UploadContent;
import sg.edu.nus.iss.server.repositories.BlobRepo;
import sg.edu.nus.iss.server.repositories.S3Repo;
...
public class UploadController {
    ...
    public ResponseEntity<byte[]> getImageById(@PathVariable Integer id){
        ...
        Optional<UploadContent> opt = blobRepo.selectUploadById(id);
        if (opt.isEmpty()){
